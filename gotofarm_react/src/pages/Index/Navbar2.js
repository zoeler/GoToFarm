          ...
          <nav className="navbar navbar-expand-md d-flex">
            <div className="hamburger-buttom-mb">
              ...
              <div
                ...
                style={{ width: '200px' }}
              >
                <ul className="navbar-nav me-auto mb-2 mb-md-0 mt-md-5 m-md-auto position-absolute d-flex justify-content-center">
                  <div className="w-70 offcanvas-header align-items-baseline gap-3 pb-0">
